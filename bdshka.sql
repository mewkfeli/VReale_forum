...
--
-- Host: localhost    Database: bdshka
-- ------------------------------------------------------
...
CREATE TABLE `posts` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `status` enum('принято','просмотр','отклонено') NOT NULL DEFAULT 'просмотр',
  PRIMARY KEY (`id`),
...
INSERT INTO `posts` VALUES (1,1,NULL,1,'Аноним','Почему трава зеленая?','Вот сижу думаю, почему трава зеленая?','2025-04-28 09:40:42','просмотр'),(2,2,NULL,1,'Философ','Философский тред','Давайте обсудим смысл жизни','2025-04-28 09:40:42','просмотр'),(3,3,NULL,1,'Геймер','Обсуждение Elden Ring','Кто прошел Elden Ring?','2025-04-28 09:40:42','просмотр'),(4,4,NULL,1,'Критик','Лучшие игры 2023 года','Какие игры вам понравились?','2025-04-28 09:40:42','просмотр'),(5,5,NULL,1,'Редактор','Главные новости сегодня','Сегодня произошло важное событие...','2025-04-28 09:40:42','просмотр'),(6,6,NULL,1,'Отаку','Какое аниме посмотреть?','Посоветуйте хорошее аниме','2025-04-28 09:40:42','просмотр'),(7,1,NULL,0,'Биолог',NULL,'Трава зеленая из-за хлорофилла','2025-04-28 09:40:42','просмотр'),(8,1,NULL,0,'Аноним',NULL,'А мне кажется, это заговор','2025-04-28 09:40:42','просмотр'),(9,2,NULL,0,'Мудрец',NULL,'Смысл жизни в 42','2025-04-28 09:40:42','просмотр'),(10,2,NULL,0,'Скептик',NULL,'Жизнь не имеет смысла','2025-04-28 09:40:42','просмотр'),(11,3,NULL,0,'Хардкорщик',NULL,'Elden Ring - шедевр!','2025-04-28 09:40:42','просмотр'),(12,3,NULL,0,'Новичок',NULL,'Слишком сложно для меня','2025-04-28 09:40:42','просмотр'),(13,6,NULL,0,'Анимешник',NULL,'Советую Attack on Titan','2025-04-28 09:40:42','просмотр'),(14,6,NULL,0,'Аноним',NULL,'Demon Slayer тоже хорош','2025-04-28 09:40:42','просмотр');
...
-- Dump completed on 2025-05-12 23:58:37
